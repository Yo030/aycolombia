...
public class DelayChao : MonoBehaviour
{
    ...
    void Awake()
    {
        Minijuego.GetComponent<Movimintocha>().enabled = false; //PONER EL NOMBRE DEL SCRIPT DEL CONTROLADOR DEL JUEGO
        UI_Tiempo.GetComponent<Tiemo>().enabled = false; //PONER EL NOMBRE DEL SCRIPT DEL TIMEPO
